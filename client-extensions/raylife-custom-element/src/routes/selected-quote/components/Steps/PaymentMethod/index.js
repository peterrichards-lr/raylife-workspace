...
const PaymentMethod = () => {
        ...
        options: [
          {
            ...
            title: `Pay in full - ${setPaymentFormat(productDiscount)}`,
          },
          {
            checked: false,
            description: '',
            ...
            title: `2 payments of ${setPaymentFormat(productPriceParcel)}`,
          },
        ],
        title: item.name,
        value: item.key,
  ...
  useEffect(() => {
    createAccount(
      ...
      if (!orderId) {
        createOrder(account.id, channel.id, skus[0].id).then((response) => {
            ...
            {checkedMethod.options.length ? (
              <>
                <div className="d-sm-flex">
                  {checkedMethod.options.map((option, index) => (
                    <div
                ...
                <div className="d-flex flex-row">
                  ...
                  <p className="align-items-center c-mb-6 d-flex justify-content-center justify-content-md-end text-paragraph-sm">
                    <span>
                      ...
                      <strong>Raylife Terms and Conditions</strong>
                    </span>
                  </p>
                </div>
                <div className="c-mb-2 c-mt-7 d-flex justify-content-center justify-content-sm-end payment-button">
                  <ClayButton
                    ...
                    onClick={() => onClickPayNow(checkedMethod)}
                  >
                    Pay Now
                  </ClayButton>
                </div>
